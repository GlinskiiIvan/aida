...
const StudyPage = () => {
  ...
  const [triggerPatients, { data: allPatientsData, isLoading: patientsIsLoading }] =
    patientApi.useLazyFindAllPatientsQuery();
      ...
      <ManagedTable
        ...
        record={{
          body: (
            <Stack direction="column" gap="md" justify="flex-start" align="stretch">
              ...
              <Button variant={"secondary"} onClick={handleFileInputClick}>
                {recordFields.dicomZip?.name || t("common.dicomZip")}
              </Button>
              <input
                id="dicomZip"
                ref={fileInputRef}
          ...
          toFormData: () => {
            ...
            recordFields.patient &&
              formData.append("patientId", recordFields.patient.id.toString());
