export default {
  pages: {
    ...
    home: {
      title: "AI Diagnostic Assistant жүйесіне қош келдіңіз",
      description: "Жасанды интеллект алгоритмдерін қолдайтын тізе буынының МРТ-зерттеулерін сақтау, өңдеу және талдау жүйесі.",

      sections: {
        studies: {
          title: "Зерттеулермен жұмыс",
          items: {
            upload: "DICOM мұрағаттарын жүктеу",
            processing: "Деректерді автоматты өңдеу",
            storage: "Сериялар мен кескіндерді сақтау",
        ...
        ai: {
          title: "ЖИ талдауы",
          items: {
            models: "Үйретілген модельдерді іске қосу",
            detection: "Зақымдану белгілерін анықтау",
            confidence: "Нәтижелердің сенімділігін бағалау",
            history: "Болжамдар тарихын сақтау"
          }
        },

        management: {
          title: "‍️Деректерді басқару",
          items: {
            patients: "Пациенттер дерекқорын жүргізу",
            studies: "Зерттеулерді басқару",
            metadata: "DICOM метадеректерін қарау",
            analysis: "Талдау нәтижелерін бақылау"
          }
        }
      },
      ...
      gettingStarted: {
        ...
        steps: {
          createPatient: "Пациентті құрыңыз немесе бар пациентті таңдаңыз.",
          uploadStudy: "МРТ-зерттеуі бар мұрағатты жүктеңіз.",
          waitProcessing: "Деректерді өңдеу аяқталғанша күтіңіз.",
          openStudy: "Кескіндерді қарау үшін зерттеуді ашыңыз.",
          runInference: "Қажет болған ЖИ талдауын іске қосыңыз."
        }
      }
    },
    admin: {
